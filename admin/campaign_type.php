                                        ...
                                        <div class="card-header">
                                            <h3 class="card-title">
                                                ...
                                                if (isset($_GET['id'])) {
                                                    ...
                                                    $Q = "SELECT * FROM `campaign_types` WHERE `id`='{$id}' AND `type`='{$type}' AND `company_id`='{$global_company_id}' AND `branch_id`='{$global_branch_id}' AND `deleted_at` IS NULL";
...
?>
    <script>
        function saveFORM() {
            ...
            var typeArray = [<?php echo '"' . implode('","', array_values(config('campaign_types.type.value'))) . '"' ?>];
            ...
            if (id.value == 0 && A == '') {
                ...
                $.ajax({
                    type: "POST", url: "ajax/campaign_type.php",
