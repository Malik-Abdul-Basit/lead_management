                                        ...
                                        <div class="card-header flex-wrap py-5">
                                            ...
                                            <div class="card-toolbar">
                                                ...
                                                if (hasRight($user_right_title, 'add')) {
                                                    echo '<a href="' . $admin_url . 'sales_person" class="btn btn-primary font-weight-bolder">'.config('lang.button.title.new_record').'</a>';
                                                }
                                                ?>
                                            </div>
                                        </div>
                                                            ...
                                                            <div class="col-md-4 my-2 my-md-0">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select id="BG_GenderFilter" onchange="getData()" <?php echo $ApplySelect2; ?>>
                                                                        ...
                                                                        <?php
                                                                        foreach (config('sales_persons.gender.title') as $key => $val) {
