                                ...
                                <div class="card-header flex-wrap py-5">
                                    ...
                                    <div class="card-toolbar">
                                        ...
                                        if (hasRight($user_right_title, 'add')) {
                                            echo '<a href="' . $admin_url . $type.'_campaign_type" class="btn btn-primary font-weight-bolder">'.config('lang.button.title.new_record').'</a>';
                                        }
                                        ?>
                                    </div>
                                </div>
...
?>
    <script>
        ...
        function getAllPageData(filter) {
            loader(true);
            $.ajax({
                type: "POST", url: 'ajax/fetch/campaign_types.php',
                data: {'filters': filter},
                ...
                if (result.value) {
                    ...
                    if(D){
                        ...
                        $.ajax({
                            ...
                            data: "delete_campaign_type=" + id + "&user_right_title=<?php echo $user_right_title; ?>" + "&type=" + type,
                            success: function (resPonse) {
                                if (resPonse !== undefined && resPonse != '') {
                                    var obj = JSON.parse(resPonse);
