                                    ...
                                    <div class="card-header flex-wrap py-5">
                                        ...
                                        <div class="card-toolbar">
                                            ...
                                            if (hasRight($user_right_title, 'add')) {
                                                echo '<a href="' . $admin_url . 'daily_progress" class="btn btn-primary font-weight-bolder">'.config('lang.button.title.new_record').'</a>';
                                            }
                                            ?>
                                        </div>
                                    </div>
                                            ...
                                            <div class="row align-items-center">
                                                <div class="col-lg-12 col-xl-12">
                                                    <div class="row align-items-center">
                                                        ...
                                                        <div class="col-md-4 my-2 my-md-0">
                                                            <div class="form-group">
                                                                <label for="BG_SalesPersonFilter">Person</label>
                                                                <select id="BG_SalesPersonFilter" onchange="getData()" <?php echo $ApplySelect2; ?>>
                                                                    <?php
                                                                    $condition = '';
...
<script>
    ...
    function getAllPageData(filter) {
        loader(true);
        $.ajax({
            type: "POST", url: 'ajax/fetch/daily_progress_details.php',
            data: {'filters': filter},
            ...
            if (result.value) {
                ...
                if (D) {
                    ...
                    $.ajax({
                        ...
                        data: "delete_daily_progress=" + id + "&user_right_title=<?php echo $user_right_title; ?>",
                        success: function (resPonse) {
                            if (resPonse !== undefined && resPonse != '') {
                                var obj = JSON.parse(resPonse);
