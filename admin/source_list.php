                                ...
                                <div class="card-header flex-wrap py-5">
                                    ...
                                    <div class="card-toolbar">
                                        ...
                                        if (hasRight($user_right_title, 'add')) {
                                            echo '<a href="' . $admin_url . $type.'_source" class="btn btn-primary font-weight-bolder">'.config('lang.button.title.new_record').'</a>';
                                        }
                                        ?>
                                    </div>
                                </div>
                ...
                if (result.value) {
                    ...
                    if(D){
                        ...
                        $.ajax({
                            ...
                            data: "delete_source=" + id + "&user_right_title=<?php echo $user_right_title; ?>" + "&type=" + type,
                            success: function (resPonse) {
                                if (resPonse !== undefined && resPonse != '') {
                                    var obj = JSON.parse(resPonse);
